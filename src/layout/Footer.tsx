...
const links = [
  { url: 'https://www.dougmcdonald.co.uk', label: 'dougmcdonald.co.uk © 2026' },
  { url: 'https://github.com/dougajmcdonald', label: '', icon: GithubLogoIcon },
  { url: 'mailto:dougajmcdonald@gmail.com', label: '', icon: EnvelopeIcon },
]
